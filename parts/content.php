...
<main class="container py-5">
    ...
    <section class="row posts-section">
        ...
        <div class="row py-3">
            <div class="card card-author border-0 d-flex">
                <div class="col">
                <?php echo get_avatar( get_the_author_meta( 'user_email' ), 62, 'robohash', 'Avatar de Autor', array( 'class' => 'img-author rounded-circle' ) );?>
                </div>
                <div class="col">
